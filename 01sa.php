<?php
    $minions = array( 
        ...
        print "</table><br>"; 
        echo "Number of Elements in an Array:" . count($minions[0]);
        echo "<br>";
        $favorite = $minions[7]['species'];
        echo "Favorite specie: ".$favorite;

        echo "<br><br>Practice 4-02<br>";
        echo "All species in the list: <br>";
        foreach($minions as $species){
